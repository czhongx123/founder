...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAgentList(){
                var data=[
                    {id:'112as',loginId:'啥快递的坐席1',number:'324'},
                    {id:'122d',loginId:'yyzx',number:'123'},
                    {id:'3234s',loginId:'1212',number:'1323'},
                    {id:'43sd',loginId:'345',number:'23'},
                    {id:'52ded',loginId:'sdss',number:'45'},
                    {id:'13ds',loginId:'jsd',number:'233'},
                    {id:'65sd',loginId:'阿萨德',number:'452'}                                        
                    ]
                this.dataAgent=data;
                var len = data.length;
                var arr1=[]
